			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<!-- loop_start -->
						...
						<td>order Date</td>
						<%
							com.wuzipeng.model.Order o=(com.wuzipeng.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.wuzipeng.dao.UserDao userDao=new com.wuzipeng.dao.UserDao();
						...
						<%
							...
							String paymentType=com.wuzipeng.model.Payment.findByPaymentId(con,n);
							 %>
